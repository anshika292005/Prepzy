...
const mcqPromptTemplate = ChatPromptTemplate.fromMessages([
  [
    'system',
...
const explanationPromptTemplate = ChatPromptTemplate.fromMessages([
  [
    'system',
...
const weakTopicPromptTemplate = ChatPromptTemplate.fromMessages([
  [
    'system',
...
const dailyStudyPlanTemplate = ChatPromptTemplate.fromMessages([
  [
    'system',
...
const followUpPromptTemplate = ChatPromptTemplate.fromMessages([
  [
    'system',
