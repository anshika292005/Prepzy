...
exports.updateSkillScore = updateSkillScore;
exports.getSkillLabel = getSkillLabel;
exports.getDifficultyFromScore = getDifficultyFromScore;
exports.processSessionResults = processSessionResults;
 ...
 */
function expectedScore(studentScore, questionDifficulty) {
 ...
 */
function updateSkillScore(currentScore, isCorrect, difficulty) {
...
function getSkillLabel(score) {
    ...
    if (score < 1600)
        return 'Advanced';
    if (score < 1800)
        return 'Advanced'; // Following the prompt specifications strictly
    return 'Expert';
}
/**
 ...
 */
function getDifficultyFromScore(score) {
    if (score < 1100)
        return 'Easy';
    if (score < 1300)
        return 'Medium';
 ...
 */
function processSessionResults(currentScore, results) {
