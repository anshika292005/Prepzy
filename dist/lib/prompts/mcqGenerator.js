...
exports.buildMCQPrompt = buildMCQPrompt;
exports.buildWeakTopicPrompt = buildWeakTopicPrompt;
function buildMCQPrompt(params) {
...
function buildWeakTopicPrompt(performanceData) {
